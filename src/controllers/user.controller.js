...
export const getUserChannelProfile = promiseAsyncHandler(async (req, res) => {
    ...
    return res.status(200)
        .json(
            new ApiResponse(200,
                "User's Channel Profile Fetched",
                channel[0]
            )
        )
});

export const getWatchHistory = promiseAsyncHandler(async (req, res) => {
    ...
    if (!user) throw new ApiError(500, "Could not fetch watch history");
